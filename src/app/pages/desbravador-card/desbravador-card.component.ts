...
@Component({
    selector: 'app-desbravador-card',
    templateUrl: './desbravador-card.component.html',
    styleUrls: ['./desbravador-card.component.scss']
})
export class DesbravadorCardComponent {
